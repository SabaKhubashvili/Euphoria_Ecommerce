    ...
    <section className="mt-[30px] grid lg:grid-cols-2 lg:grid-rows-2 grid-rows-4 gap-[30px] lg:h-[698px] h-[800px]">
      ...
      >
        <Image
          ...
          width={300}
          height={300}
          className="h-full self-end  xl:max-w-none lg:max-w-[263px] lg:max-h-none max-w-[197px] xs:w-fit w-[50%] "
        />
        ...
        <div className="flex flex-col  xl:gap-[51px] md:gap-[20px] gap-[10px] flex-grow">
          <div>
            ...
            <p
              className={`${Roboto.className}  lg:text-[22px] text-[10px] leading-[37px] tracking-[0.22px] font-light`}
            >
      ...
      <div
        className="col-span-1 row-span-2
         ...
         flex justify-between items-center relative  lg:max-h-none 
        "
      >
        <Image
        ...
        <div className="flex flex-col xl:gap-[51px] md:gap-[20px] gap-[10px]  flex-grow self-end xl:ml-[85px] xl:mb-[103px] md:ml-[60px] md:mb-[80px] m-4 z-10 relative">
          <div>
            <h1 className="uppercase md:leading-[62px] leading-[20px] font-semibold  xl:text-[48px] lg:text-[35px] text-[16px] max-w-[221px]">
              choose your look
            </h1>
            <p
              className={`${Roboto.className} text-[22px] leading-[37px] tracking-[0.22px] font-light`}
            >
              See our clothing collections
            </p>
          </div>
