...
import { largeScreens, smallScreens } from "@/app/Screens/Screens";
  ...
  return (
    <React.Fragment>
      <nav className="relative w-full">
          ...
          <Container>
            <div className="flex justify-between items-center">
              ...
              { isAboveSmallScreens && 
                ...
                <Link
                href={"/"}
                className=" xs:w-[70px] xl:h-[40px] md:w-[75px] md:h-[30px] w-[65px]  h-[27px]"
                >
                <Logo />
              </Link>
              }
        ...
        {!isAboveLargeScreens && <SmallScreenMenu isOpen={menuToggle} />}
      </nav>
    </React.Fragment>
  );
};
