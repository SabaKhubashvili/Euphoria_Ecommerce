...
const RowCell = ({ text }:{text:string}) => (
  <h1 className='text-black  font-medium md:text-[18px] text-[13px] basis-1/6'>{text}</h1>
);
const StatusRowCell = ({ text }:{text: 'Pending' | 'Delivered'}) => (
  <h1 className={`text-black  font-medium md:text-[18px] text-[13px] basis-1/6 ${text === 'Pending' ? 'text-yellow-500' : 'text-green'}`}>{text}</h1>
);

export const MainTable = () => {
  return (
    <div className='flex flex-col gap-[18px] w-full p-[24px]'>
      ...
      <div className='flex flex-col gap-[18px] h-[400px] overflow-y-auto'>

      <div className='flex justify-between items-center py-[8px] px-[20px]'>
        <RowCell text='#2323' />
