export const WebsiteIcons = {
  DoneCircle: `
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 40 40" fill="none">
        <circle cx="20" cy="20" r="17" transform="rotate(-180 20 20)" fill="white" stroke="#57A4EB" stroke-width="6"/>
        <line x1="15.1213" y1="20.5042" x2="18" y2="23.3828" stroke="black" stroke-width="3" stroke-linecap="square"/>
